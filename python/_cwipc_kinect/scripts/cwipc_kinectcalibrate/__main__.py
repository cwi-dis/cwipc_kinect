...
def main():
    ...
    parser.add_argument("--auto", action="store_true", help="Attempt to auto-install cameraconfig_k4a, if needed")
    parser.add_argument("--clean", action="store_true", help="Remove old cameraconfig_k4a.xml and calibrate from scratch")
    parser.add_argument("--reuse", action="store_true", help="Reuse existing cameraconfig_k4a.xml")
    parser.add_argument("--nograb", metavar="PLYFILE", action="store", help="Don't use grabber but use .ply file grabbed earlier, using cameraconfig_k4a.xml from same directory.")
