...
class Calibrator:
    ...
    def run_coarse(self):
        ...
        joined.save('cwipc_kinectcalibrate_coarse.ply')
    ...
    def run_fine(self, correspondence, inspect):
        ...
        joined.save('cwipc_kinectcalibrate_calibrated.ply')
        print("Result saved as cwipc_kinectcalibrate_calibrated.ply")
    ...
    def get_pointclouds(self):
        ...
        joined.save('cwipc_kinectscalibrate_captured.ply')
